...
namespace StudentMIS
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.Add(new ServiceDescriptor(typeof(StudentDataStoreContext), new StudentDataStoreContext(Configuration.GetConnectionString("DefaultConnection"))));          
            ...
            services.Add(new ServiceDescriptor(typeof(TeacherDataStoreContext), new TeacherDataStoreContext(Configuration.GetConnectionString("DefaultConnection"))));          
